...
<form action="poster_ok.php" method="post" enctype="multipart/form-data">
    <input type="text" name="title" placeholder="영화 제목을 적어주세요.">
    <input type="text" name="text" placeholder="개봉일을 적어주세요.">
...
<table>
  ...
  <tr>
    ...
    <td><a href="poster_del.php?id=<?=$row['wr_id']?>" class="btn" style="background: #9eacc6;color: #fff;">삭제</a></td>
  </tr>
  <?php endforeach; ?>
</table>
<?php
